...
namespace BusinessLayer.ValidationRules
{
    public class AboutValidator:AbstractValidator<About>
    {
        public AboutValidator()
        {
            ...
            RuleFor(x => x.Image1).NotEmpty().WithMessage("Liütfen görsel seçiniz");
            RuleFor(x => x.Description).MinimumLength(50).WithMessage("Lütfen en az 50 karakterlik açıklama bilgisi giriniz");
            RuleFor(x => x.Description).MaximumLength(1500).WithMessage("Lütfen açıklama bilgisini kısaltın");
        }
    }
}
