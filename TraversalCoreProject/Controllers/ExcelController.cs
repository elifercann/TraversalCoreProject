...
namespace TraversalCoreProject.Controllers
{
    public class ExcelController : Controller
    {
        ...
        public IActionResult StaticExcelReport()
        {
            ...
            workSheet.Cells[2, 1].Value = "Karadeniz Batum Turu";
            workSheet.Cells[2, 2].Value = "Asaf Şen";
            workSheet.Cells[2, 3].Value = "30";

            workSheet.Cells[3, 1].Value = "Ege Yunan Adaları Turu";
            workSheet.Cells[3, 2].Value = "Ayça Sezen";
